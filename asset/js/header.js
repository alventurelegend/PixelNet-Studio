  ...
  constructor() {
    ...
    shadow.innerHTML = `
      ...
      <header id="main-header">
        ...
        <div class="button">
          <input class="btn1" type="submit" value="Portofolio" id="btnporto"/>
          <input class="btn2" type="submit" value="Contacs" id="btncontacs" />
        </div>
      </header>
    `;

    const headerElement = shadow.getElementById("main-header");
    const btnPorto = shadow.getElementById("btnporto");
    const btnContacs = shadow.getElementById("btncontacs");
    ...
    if (btnContacs) {
      btnContacs.addEventListener("click", () => {
